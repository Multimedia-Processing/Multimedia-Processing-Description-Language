...
因此後製軟體將與Git結合，讓多人協作時可以很輕鬆的合併、比對與解決不同人所製作的檔案，透過圖形化以及即時預覽，例如單一影像即時預覽、雙影像即時比對與三影像即時合併預覽，將影像、參數與聲音使用顏色等標記做比對，合併就像呼吸一樣的順暢。

並且相對於集中式版本管控，分散式版本管控可承受上千萬人同時製作，這已經在軟體開發上證明這是可行的。

### 線下線上
隨著社會變遷，人的生活越來越繁忙，於是人們在平時調理與整理自己思緒的方式在一般人有限的腦袋下發展出各種規劃個人計畫的方式，其中著名的禱告、靜坐、沉思、筆記、三條線筆記、子彈筆記、甘特圖、日曆等管理工具監督計畫進度。

人與人組成團隊互相合作，針對多人協作的專案機制也隨之發展，針對大型且目標明確的專案，「甘特圖」(Gantt Chart)、「計劃評核術」(Program Evaluation and Review Technique)等團隊的管理方法廣為人知，而現在任務流程看板、Scrum等，以講求應變、品質與透明的管理方法崛起。

進入到電腦與網路時代，個人專案從線下轉移到雲端，發展出結合雲端的專案管理平台。

通過網路與遠端等概念，雲端運算、雲端儲存、無距離等特性，讓線上協作成為主流，讓在不同地方的人也可以通過網路聯絡、溝通達成任務。

因此，結合分散式版本管控、專案管理、社交網路、雲端運算與雲端儲存等的協作系統，讓過去必須一個人苦幹與無法快速建立與統整專案，在這個平台可以解決，甚至。

此語言的目標是為了可以達成

而團隊，也是當協作人數持續增加，用於規劃人事物的工具與機制產生是必定會發生的事情，因此案管理平台。
