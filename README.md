...
### Scrum
為了實現敏捷軟體開發宣言有人提出了Scrum，於1990年左右提出的概念並實踐，核心思想就是「全體一起前進，把求傳來傳去」，其中的概念來自於橄欖球，橄欖球中不同的角色與職位在各階段的互相重疊完成。  

#### 角色
Scrum角色有三種，「開發團隊」(Dev Team, Development Team)、「產品負責人」(PO, Product Owner)、「Scrum專家」(SM, ScrumMaster)，開發團隊負責產生內容，產品負責人負責修正與想出內容的方向，而Scrum專家類似於教練與輔導員的角色，我們稱三者組成的團隊或組織叫做Scrum Team或者Team，如下做詳細解說。  
...
#### 物件
「物件」(Item)，也稱作為Story，是產品負責人定義的，物件的大小要剛好可以團隊在平常可以完成3~5個，太多太繁雜，太少沒做完感覺沒有用，都會打擊團隊。
